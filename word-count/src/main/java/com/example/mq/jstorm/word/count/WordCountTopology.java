package com.example.mq.jstorm.word.count;
...
import com.example.mq.jstorm.word.count.storm.SentenceSpout;
import com.example.mq.jstorm.word.count.storm.SplitSentenceBolt;
import com.example.mq.jstorm.word.count.storm.WordCountBolt;
...
public class WordCountTopology {
	...
	public static void main(String[] args) throws Exception{
		...
		try {
			LocalPropertiesConfigurer localPropertiesConfigurer = SpringContextUtil.getBean(LocalPropertiesConfigurer.class);
